...
![Screenshot from 2025-12-01 11-12-22](../images/2025-11-29-Robot Model과 TF 시각화 및 조작/TFs_01.png)
...
![TFs_02](../images/2025-11-29-Robot Model과 TF 시각화 및 조작/TFs_02.png)
...
![image-20251201120852021](../images/2025-11-29-Robot Model과 TF 시각화 및 조작/image-20251201120852021.png)
...
로봇의 관절(Joints)는 `TF`를 통해 정의됩니다. 관절의 축이 두 링크 사이의 변환(TF)을 의미하며, 이는 두 부품이 서로 상대적으로 어떻게 움직이는지를 나타냅니다.
...
![Screenshot from 2025-12-01 11-54-35](../images/2025-11-29-Robot Model과 TF 시각화 및 조작/Screenshot from 2025-12-01 11-54-35.png)
